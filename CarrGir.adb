...
-- La recherche de la prochaine voiture ne focntionne pas
...
voie := i;
put_line("entrer, nbvoiture : "  & Integer'Image(nbVoiture) & ", voie : " & Integer'Image(voie));
end entrer;

procedure sortir is
begin
nbVoiture := nbVoiture -1 ;
put_line("sortir, nbvoiture : "  & Integer'Image(nbVoiture) & ", voie : " & Integer'Image(voie));
